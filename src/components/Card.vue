...
<template>
  <div class=" cursor-pointer w-70 rounded-xl shadow-[5px_5px_10px_0_#d5d5d5]">
    <img class="rounded-t-lg" :src="props.card.coverImg" />
    <div class="p-2">
        <div class="h-10">
            <span class=" text-sm w-60 text-ellipsis of-hidden break-all line-clamp-2">
                {{ props.card.title }}
            </span>
        </div>
        <div class="flex items-center my-2 text-xs">
            ...
            <span class="flex items-center">
                <img class="mr-1 w-3 h-3" src="https://front.cdn.xdclass.net/images/fire.webp" />
                <img class="mr-1 w-3 h-3" src="https://front.cdn.xdclass.net/images/fire.webp" />
                <img class="mr-1 w-3 h-3" src="https://front.cdn.xdclass.net/images/fire.webp" />
                <img class="mr-1 w-3 h-3" src="https://front.cdn.xdclass.net/images/fire.webp" />
            </span>
            ...
            <div class="flex items-center justify-center">
                <div class="c-#aaa">
                    ￥<span class="mr-1 line-through">
                        {{ props.card.oldAmount }}
                    </span>
                </div>
                <div class="c-#e51b11">
                    ￥<span class="mr-1 text-16px text-red-500">
                        {{ props.card.amount }}
                    </span>
                </div>
            </div>
