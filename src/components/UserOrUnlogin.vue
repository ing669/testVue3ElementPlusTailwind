  ...
  >
    <div class="w-40 h-60">
        ...
        <div v-else class="flex flex-col items-center justify-center h-full">
            <img class=" cursor-pointer mb-1 mt-10 w-50 h-50" src="https://front.cdn.xdclass.net/images/new.webp"/>
            <el-button
                @click="module.switchLoginVisible()"
                class="text-center bg-#ff602a curpsor-pointer rounded-71px w-130px h-24px text-12px p2 leading"
            >
            登录 / 注册
            </el-button>
        </div>
